...
PRODUCT = "trade-optimize"
CURRENT_VERSION = "0.1.0"
UPDATE_URL = "https://api.github.com/repos/crieck2010/trade-optimize/releases/latest"
...
def check_license(key: str | None = None) -> dict:
    ...
    changing call sites.
    """
    key = key or os.environ.get("TRADE_OPTIMIZE_LICENSE", "")
...
def check_update(timeout: int = 10) -> dict:
    ...
    try:
        req = urllib.request.Request(UPDATE_URL, headers={"User-Agent": PRODUCT})
